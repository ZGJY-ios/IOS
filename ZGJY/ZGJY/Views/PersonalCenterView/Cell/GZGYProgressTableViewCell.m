...
//        dateLabel.font = [UIFont systemFontOfSize:13];
        ...
        promptLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:25], [GZGApplicationTool control_height:105], KScreenWigth - [GZGApplicationTool control_wide:50], [GZGApplicationTool control_height:100])];
        promptLabel.text = @"您的服务单已经操作完成，如有疑问请联系客服";
        promptLabel.numberOfLines = 2;
        [self addSubview:promptLabel];
        dividerLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, [GZGApplicationTool control_height:225], KScreenWigth, 1)];
