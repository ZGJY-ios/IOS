...
@implementation GZGYEvaluaImgTableViewCell

//@synthesize iconView,nameLabel,addressLabel,dateLabel,timeLabel,lineLabel,starView,contentLabel,praiseBtn,numberLabel,commentsBtn,comnumberLabel,dividerLabel,shopView;
...
//        iconView.layer.borderColor = [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0].CGColor;
...
//        dividerLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, [GZGApplicationTool control_height:235], SCREENWIDTH, 1)];
//        dividerLabel.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0];
        [self addSubview:self.dividerLabel];
        
        for (int i = 0; i<3; i++) {
            _shopView = [[UIImageView alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:80]+[GZGApplicationTool control_wide:95]*i, [GZGApplicationTool control_height:250], [GZGApplicationTool control_wide:80], [GZGApplicationTool control_height:100])];
            _shopView.image = [UIImage imageNamed:@"图层-33.jpg"];
            _shopView.layer.cornerRadius = 0;
            _shopView.layer.borderColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0].CGColor;
            _shopView.layer.borderWidth = 1;
            [_shopView.layer setMasksToBounds:YES];
