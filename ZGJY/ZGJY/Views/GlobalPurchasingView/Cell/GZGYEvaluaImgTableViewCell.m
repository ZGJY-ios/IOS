...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        dividerLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, [GZGApplicationTool control_height:235], KScreenWigth, 1)];
        ...
        for (int i = 0; i<3; i++) {
            shopView = [[UIImageView alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:80]+[GZGApplicationTool control_wide:95]*i, [GZGApplicationTool control_height:250], [GZGApplicationTool control_wide:80], [GZGApplicationTool control_height:100])];
            shopView.image = [UIImage imageNamed:@"图层-33.jpg"];
            shopView.layer.cornerRadius = 0;
            shopView.layer.borderColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0].CGColor;
            shopView.layer.borderWidth = 1;
            [shopView.layer setMasksToBounds:YES];
