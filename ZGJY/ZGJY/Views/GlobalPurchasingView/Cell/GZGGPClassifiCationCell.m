...
//                          @"QQG_OZG"];
    ...
    for (NSInteger i = 0 ; i<array.count; i++) {
        ...
        [cakssufuCationBtn sd_setImageWithURL:[NSURL URLWithString:[array[i] objectForKey:@"icon"]] forState:UIControlStateNormal placeholderImage:nil];
        [cakssufuCationBtn setTitle:[array[i] objectForKey:@"name"] forState:UIControlStateNormal];
