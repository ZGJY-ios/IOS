...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        startLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:60], [GZGApplicationTool control_height:15], [GZGApplicationTool control_wide:145], [GZGApplicationTool control_height:40])];
...
//        [startLabel.layer setMasksToBounds:YES];
        ...
        countLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:210], [GZGApplicationTool control_height:15], [GZGApplicationTool control_wide:140], [GZGApplicationTool control_height:40])];
...
//        [countLabel.layer setMasksToBounds:YES];
        ...
        AbulkLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:20], [GZGApplicationTool control_height:55], [GZGApplicationTool control_wide:365], [GZGApplicationTool control_height:40])];
