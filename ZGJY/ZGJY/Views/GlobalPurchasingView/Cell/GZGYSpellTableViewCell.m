...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        imgView = [[UIImageView alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:20], [GZGApplicationTool control_height:25], [GZGApplicationTool control_wide:220], [GZGApplicationTool control_height:175])];
        ...
        reasonLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:280], [GZGApplicationTool control_height:60], SCREENWIDTH - [GZGApplicationTool control_wide:300], [GZGApplicationTool control_height:60])];
        ...
        priceLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:280], [GZGApplicationTool control_height:125], [GZGApplicationTool control_wide:100], [GZGApplicationTool control_height:30])];
        priceLabel.text = @"拼团价:";
        priceLabel.font = [UIFont systemFontOfSize:14];
        priceLabel.textColor = [UIColor colorWithRed:252/255.0 green:16/255.0 blue:59/255.0 alpha:1.0];
        [self addSubview:priceLabel];
        pricenumber = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:380], [GZGApplicationTool control_height:125], [GZGApplicationTool control_wide:200], [GZGApplicationTool control_height:30])];
        ...
        marketLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:280], [GZGApplicationTool control_height:165], [GZGApplicationTool control_wide:100], [GZGApplicationTool control_height:30])];
        ...
        marketPrice = [[GZGYStrikeThroughLabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:380], [GZGApplicationTool control_height:165], [GZGApplicationTool control_wide:200], [GZGApplicationTool control_height:30])];
        ...
        replenishBtn.frame = CGRectMake(SCREENWIDTH - [GZGApplicationTool control_wide:140], [GZGApplicationTool control_height:150], [GZGApplicationTool control_wide:120], [GZGApplicationTool control_height:40]);
        ...
        lineLabel = [[UILabel alloc]initWithFrame:CGRectMake([GZGApplicationTool control_wide:20], [GZGApplicationTool control_height:233], SCREENWIDTH-[GZGApplicationTool control_wide:20], [GZGApplicationTool control_height:2])];
