...
@protocol ChoiceDelegeteClickProtocol<NSObject>
...
@property(nonatomic,retain)id<ChoiceDelegeteClickProtocol>delegate;
...
@property(nonatomic, strong)UILabel * snLabel;//商品编号
