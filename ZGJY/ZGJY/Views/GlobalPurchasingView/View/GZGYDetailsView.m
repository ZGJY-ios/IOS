...
-(instancetype)initWithFrame:(CGRect)frame andImageArr:(NSArray *)imageArr
{
    ...
    if (self) {
        ...
        serialLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        numberLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        priceLabel.text = @"销售价:";
        priceLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        startLabel.text = @"起批量:";
        startLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        wholeLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        givingLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        integralLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
        ...
        countLabel.font = [UIFont systemFontOfSize:[GZGApplicationTool control_height:30]];
