...
- (void)setMenuModel:(id)menuModel {
    ...
    self.customTitleLabel.textColor = [UIColor colorWithRed:195 / 255.0 green:197 / 255.0 blue:198 / 255.0 alpha:1.0];
...
@interface GZGSPDropMenuView () <UITableViewDataSource, UITableViewDelegate>
/**tableView*/
...
@implementation GZGSPDropMenuView
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.triangleColor = FFColor(0, 0, 0, 0.6);
        self.triangleY = 64;
...
+ (instancetype)ff_DefaultStyleDropDownMenuWithMenuModelsArray:(NSArray *)menuModelsArray menuWidth:(CGFloat)menuWidth eachItemHeight:(CGFloat)eachItemHeight menuRightMargin:(CGFloat)menuRightMargin triangleRightMargin:(CGFloat)triangleRightMargin {
    ...
    GZGSPDropMenuView *menuView = [GZGSPDropMenuView new];
